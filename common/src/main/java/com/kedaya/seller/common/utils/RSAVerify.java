...
public class RSAVerify {
    private static Logger LOGGER = LoggerFactory.getLogger(RSAVerify.class);
    ...
    public static void main(String[] args) {
        String text = "{\"amount\":0,\"chanId\":\"10\",\"chanUserId\":\"10\",\"createAt\":\"2018-12-365 14:46:16\",\"memo\":\"123\",\"outerOrderId\":\"132\",\"productId\":\"101\"}";
        String sign = RSAVerify.sign(text,RSAUtils.privateKey);
        System.out.println(sign);
        System.out.println(RSAVerify.verify(text, sign, RSAUtils.publicKey));
    }
