...
public class JedisUtil {
	...
	public static final int DEFAULT_EXPIRE_TIME = 3600; // 默认过期时间,单位/秒, 60*60=1H, 一小时
	public static final int DEFAULT_EXPIRE_DAY = 86400; // 默认过期时间,单位/秒, 60*60*24=24H, 一天
	...
	public static void main(String[] args) {
		...
		//setObjectValue("key", JMockData.mock(String.class));
		//expire("key",10);

		System.out.println(getObjectValue("99e41b75-1ea5-46a1-8759-5eaaac900adc"));
